---
title: Nuxt UI v3
description: Nuxt UI v3 已发布！经过 1500+ 次提交，这次重大重新设计带来了
  更好的可访问性、Tailwind CSS v4 支持以及完整的 Vue 兼容性
...
• **导航**：菜单、选项卡和面包屑，直观引导用户

• **反馈**：提示、警报和模态框，清晰传达信息

• **表单**：输入框、选择器和数据验证，简化数据收集

• **布局**：网格、容器和响应式系统，优雅地组织内容
