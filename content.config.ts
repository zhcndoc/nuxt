...
const docsV3Source = {
  ...
  repository: !process.env.NUXT_V3_PATH ? 'https://github.com/zhcndoc/nuxt-docs/tree/3.x' : undefined,
  include: 'docs/**/*',
  exclude: ['docs/**/*.json'],
  prefix: '/docs/3.x'
}
...
const docsV4Source = {
  ...
  repository: !process.env.NUXT_V4_PATH ? 'https://github.com/zhcndoc/nuxt-docs/tree/4.x' : undefined,
  include: 'docs/**/*',
  exclude: ['docs/**/*.json'],
  prefix: '/docs/4.x'
}
...
const docsV5Source = {
  ...
  repository: !process.env.NUXT_V5_PATH ? 'https://github.com/zhcndoc/nuxt-docs/tree/main' : undefined,
  include: 'docs/**/*',
  exclude: ['docs/**/*.json'],
  prefix: '/docs/5.x'
}
