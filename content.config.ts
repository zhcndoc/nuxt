...
const docsV3Source = {
  ...
  repository: !process.env.NUXT_V3_PATH ? 'https://github.com/zhcndoc/nuxt-docs/tree/v3' : undefined,
  include: 'docs/**/*',
  exclude: ['docs/**/*.json'],
  prefix: '/docs/3.x'
}
...
const docsV4Source = {
  ...
  repository: !process.env.NUXT_V4_PATH ? 'https://github.com/zhcndoc/nuxt-docs/tree/main' : undefined,
  include: 'docs/**/*',
  exclude: ['docs/**/*.json'],
  prefix: '/docs/4.x'
}
